...
<body onload="slider()">
    ...
    <h4 style="margin-left:115px">Không có sản phẩm nào trong đây cả :((</h4><br><br>';
        ...
        &emsp;&emsp;&emsp;&emsp;&nbsp;
        <a href="../cart/" class="linktocheckout button dark">Thanh toán</a>
    ...
    <div class="bg-main close-cart">
        <div class="container">
            ...
            <img id="slide" class="zoom" style="width: 100%;  max-height: 500px;" src="https://beptot.vn/Data/ResizeImage/images/bannerx1030x340x4.webp">
